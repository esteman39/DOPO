...
public class Solution{
     ...
     */
    public Solution(int numCups, int numHeight){
    ...
    public boolean firstInstance(){
        if(reach > maxHeight || reach < minHeight){
            return false;
        }
        return true;
    }
     ...
     */
    public ArrayList<Integer> secondInstance(ArrayList<Integer> torre, int objetivo){
    ...
    public ArrayList<Integer> getSolution(){
        if(reach == minHeight){
            ...
            if(!internalSolution.firstInstance()){
                ...
                subInternalSolution = secondInstance(lista, reach-(((maxCups)*2) - 1));
     ...
     */
    private boolean search(ArrayList<Integer> torre, int objetivo, int index, int suma, ArrayList<Integer> actual, ArrayList <Integer> lista){
        if(suma == objetivo){
            lista.addAll(actual);
            return true;
        }
